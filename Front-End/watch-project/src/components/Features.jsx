            ...
            <div className="feature-section">
                ...
                <div className="features-container">
                    <div className="feature feature-1">
                        <img src="/images/collab.png" alt="" />  {/* Image is imported from public folder */}
                        <p>Collaboration model</p>
                    </div>

                    <div className="feature feature-2">
                       <img src="/images/shock.png" alt="" />  {/* Image is imported from public folder */}
                       <p>Shock resistant</p>
                    </div>

                    <div className="feature feature-3">
                        <img src="/images/water-resistant.png" alt="" />  {/* Image is imported from public folder */}
                        <p>20 bar water resistant</p>
                    </div>

                    <div className="feature feature-4">
                        <img src="/images/your-time.png" alt="" />  {/* Image is imported from public folder */}
                       <p>Keeps yourself in time</p>
                    </div>

                   <div className="feature feature-5">
                        <img src="/images/solor.png" alt="" />  {/* Image is imported from public folder */}
                        <p>Stable solar power</p>
                    </div>

                    <div className="feature feature-6">
                        <img src="/images/bluetooth.png" alt="" />  {/* Image is imported from public folder */}
